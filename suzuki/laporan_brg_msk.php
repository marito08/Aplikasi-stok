...
$pdf->Cell(0,0.7,'Laporan Barang Masuk Mobil Suzuki',0,0,'C');
$pdf->ln(1);
$pdf->SetFont('Arial','B',10);
$pdf->Cell(5,0.7,"Di cetak pada : ".date("D-d/m/Y"),0,0,'C');
$pdf->ln(1);
$pdf->Cell(7,0.8,"Laporan Penjualan pada tanggal:" .$_GET['tanggal'] ,0,0,'C');
...
$query=mysql_query("select * from brg_msk_suzuki LEFT JOIN suzuki_mobil USING(mobil) where tanggal='$tanggal'" );
...
$q=mysql_query("select sum(jumlah*harga)  as total from brg_msk_suzuki LEFT JOIN suzuki_mobil USING(mobil) where tanggal='$tanggal'" );
